...
import 'package:unemindemaville/layouts/auth/registerUser.dart';
...
class _LoginUserState extends State<LoginUser> {
  ...
  tryConnexion() async {
    ...
    await _authService
        .signInUserEmailAndPassword(emailController.text, passController.text)
        .then((result) {
      setState(() {
        loading = false;
      });
      switch (result) {
        ...
        case 7:
          _showDialog(
              "ERREUR IDENTIFICATION", "Vous n'êtes pas enregistré comme utilisateur !");
          break;
        default:
          _showDialog("ERREUR",
